...
DownloadMissing chain, keeps an SSE connection open, samples health/WAL/worker
diagnostics and Docker resource use, and writes API p50/p95/p99 plus SSE delivery
delay to a run-id directory.
