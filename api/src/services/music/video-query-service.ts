...
export function getVideoDetail(videoId: string): VideoDetailContract | null {
  ...
  if (canonicalRow) {
    ...
    detail.related_tracks = relatedTracksForVideoDetail(
      ...
      edition_id: track.editionId,
      release_mbid: track.releaseMbid,
      edition_title: track.editionTitle,
      edition_disambiguation: track.editionDisambiguation,
      edition_date: track.editionDate,
      edition_country: track.editionCountry,
      edition_media_formats: track.editionMediaFormats,
      edition_track_count: track.editionTrackCount,
      placement_library_id: track.placementLibraryId,
      library_name: track.libraryName,
