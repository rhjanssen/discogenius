...
const SYSTEM_TASK_DEFINITIONS = [
  {
    ...
    description: "Refresh due monitored artists, provider availability, and curation state.",
  ...
  },
  {
    ...
    name: "Rescan Folders",
    description: "Reconcile the configured library roots with tracked media files.",
  ...
  },
  {
    ...
    name: "Backup Database",
    description: "Create a consistent SQLite backup and prune backups beyond the retention window.",
    taskName: CommandNames.BackupDatabase,
    category: "maintenance",
    riskLevel: "low",
    visibleInSystemTasks: false,
    run: () => queueBackupDatabase({ trigger: CommandTrigger.Manual }),
  },
  {
    id: "refresh-metadata",
    kind: "manual",
