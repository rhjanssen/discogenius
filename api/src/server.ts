...
// Docker / Compose liveness. Diagnostics live on /health; a failed deep check
// or last week's import must not mark the container unhealthy and block the
// Apple Music wrapper's depends_on.
