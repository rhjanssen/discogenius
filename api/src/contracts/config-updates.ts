...
const FILTERING_UPDATE_KEYS = [
  ...
  "include_status_official",
  "include_status_promotion",
  "include_status_bootleg",
  "include_status_pseudo_release",
  "include_status_withdrawn",
  "include_status_cancelled",
  "include_status_expunged",
  "include_status_unknown",
  "include_spatial",
  "include_videos",
